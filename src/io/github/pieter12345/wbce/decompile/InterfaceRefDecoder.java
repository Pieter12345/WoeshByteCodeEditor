...
public class InterfaceRefDecoder {
	...
	public InterfaceRefDecoder(ClassConstantPool constPool, int methodDescIndex) throws DecompileException {
		try {
			ConstantPoolInterfaceRef interfaceRef = (ConstantPoolInterfaceRef) constPool.get(methodDescIndex, ConstantPoolInterfaceRef.class);
			
			ConstantPoolClassRef classRef = (ConstantPoolClassRef) constPool.get(interfaceRef.getClassIndex(), ConstantPoolClassRef.class);
			ConstantPoolNameAndTypeDesc methodNameAndTypeDesc =
					(ConstantPoolNameAndTypeDesc) constPool.get(interfaceRef.getNameAndTypeIndex(), ConstantPoolNameAndTypeDesc.class);
